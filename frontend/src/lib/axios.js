...
const API_BASE_URL = rawApi.endsWith("/api") ? rawApi : `${rawApi.replace(/\/+$/, "")}/api`;
const SOCKET_URL = import.meta.env.VITE_SOCKET_URL || rawApi.replace(/\/api\/?$/, "") || "http://localhost:3000";
