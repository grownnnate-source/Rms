...
export const SalesChart = ({
  ...
  const paddingX = 35;
  const paddingY = 25;
  return <div className="bg-white p-5 rounded-2xl border border-[#5A3E36]/10 shadow-xs space-y-4">
    ...
    return <button
      ...
      className={`px-3 py-1 rounded-lg text-xs font-bold transition-all cursor-pointer ${isSelected ? "bg-[#5A3E36] text-white shadow-2xs" : "text-[#78716C] hover:text-[#5A3E36]"}`}
    >
                {p}
              </button>;
  })}
  ...
  >
    ...
    /* Hovered Tooltip Pill */
        ...
        {hoveredIdx !== null && data[hoveredIdx] && <div
