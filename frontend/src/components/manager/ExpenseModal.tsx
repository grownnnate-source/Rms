...
import { X, DollarSign, Tag, Calendar, User } from 'lucide-react';
...
export const ExpenseModal: React.FC<ExpenseModalProps> = ({ onClose, onSave }) => {
  const [title, setTitle] = useState('');
  const [category, setCategory] = useState<typeof EXPENSE_CATEGORIES[number]>('Dairy & Cream');
