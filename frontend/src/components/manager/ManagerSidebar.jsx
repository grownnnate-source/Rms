...
export const ManagerSidebar = ({
  ...
  const tabs = [
    ...
    { id: "orders", label: "Orders Archive", icon: ShoppingBag, count: ordersCount },
    { id: "products", label: "Products", icon: Layers, count: productsCount },
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <Icon
                    className={`w-4 h-4 ${
                      isActive ? "text-[#F58FA3]" : "text-[#78716C]"
                    }`}
                  />
                  <span>{tab.label}</span>
                </div>
