          ...
          <div className="relative flex-1 sm:w-64">
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-2.5 top-1/2 -translate-y-1/2 text-xs text-[#78716C] hover:text-[#5A3E36] cursor-pointer"
              >
                ×
              </button>
            )}
      ...
      {showSubmissionSuccess && lastSubmittedOrder && (
        <div className="mb-4 p-3.5 rounded-xl bg-[#65A30D]/15 border border-[#65A30D]/30 text-[#4D7C0F] flex items-center justify-between animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <button
            ...
            className="text-xs font-semibold underline text-[#4D7C0F] cursor-pointer"
          >
            Dismiss
          </button>
        </div>
